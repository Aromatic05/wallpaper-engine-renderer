...
|---|---|---|---|
| `791f273` | audio bar shader compatibility | `REVIEW` | Add shader corpus fixture, compare spec names/combinations. |
| `23e0b14` | update shader spec uniforms | `REVIEW` | Compare parsed uniform schema before modifying updater code. |
| `2728164` | discover non-standard pkg names | `PORT` | Replace hard-coded package discovery with project/package evidence. |
